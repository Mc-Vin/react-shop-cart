...
import { CartWrapper, OrderList } from './style';
        ...
        this.state = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    align: 'center',
                    render: (text, record) => {
                        return (<img src={record.url} style={{ width: '100px', height: '120px' }} alt='' />);
                    }
                },
                {
                    title: '数量',
                ...
                },
                {
                    ...
                    key: 'action',
                    align: 'center',
                    render: (text, record) => <Button type='danger' onClick={() => { this.handleItemDelete(record.id); }}>Delete</Button>
                },
            ],
            data: store.getState()
        };
